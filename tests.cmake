...
MACRO(BUILD_TEST FILE_NAME)
  ...
  SET_PROPERTY(
    ...
    "PATH=${Boost_LIBRARY_DIR_RELEASE}${SEP}${CMAKE_INSTALL_PREFIX}/bin${SEP}$ENV{PATH}"
  )

  set(LTDL_LIBRARY_PATH "${CMAKE_BINARY_DIR}/src${SEP}${CMAKE_INSTALL_PREFIX}/lib/roboptim-core${SEP}$ENV{LTDL_LIBRARY_PATH}")
  IF(MSVC AND "${CMAKE_GENERATOR}" MATCHES "Visual Studio.*")
    FOREACH(conf ${CMAKE_CONFIGURATION_TYPES})
      set(LTDL_LIBRARY_PATH "${CMAKE_BINARY_DIR}/src/${conf}${SEP}${LTDL_LIBRARY_PATH}")
    ENDFOREACH()
  ENDIF()
  message(STATUS "LTDL_LIBRARY_PATH ${LTDL_LIBRARY_PATH}")
  SET_PROPERTY(
