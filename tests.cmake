...
# ------------------------------
#
# Set the environment properties for the tests (PATH, LTDL_LIBRARY_PATH ...)
#
MACRO(SET_TEST_PROPERTIES EXE_NAME)
  IF(WIN32)
    SET(SEP "\\;")
  ELSE()
    SET(SEP ":")
  ...
  ENDIF()
  SET_PROPERTY(
    TEST ${EXE_NAME} PROPERTY ENVIRONMENT
  ...
  IF(WIN32)
    SET_PROPERTY(
      TEST ${EXE_NAME} APPEND PROPERTY ENVIRONMENT
      "PATH=${Boost_LIBRARY_DIR_RELEASE}${SEP}${CMAKE_INSTALL_PREFIX}/bin${SEP}${CMAKE_INSTALL_PREFIX}/lib${SEP}${CMAKE_INSTALL_PREFIX}/lib/roboptim-core${SEP}$ENV{PATH}"
    )
  ELSE()
    SET_PROPERTY(
      TEST ${EXE_NAME} APPEND PROPERTY ENVIRONMENT
...
MACRO(BUILD_TEST FILE_NAME)
  ...
  SET_TEST_PROPERTIES(${EXE_NAME}${PROGRAM_SUFFIX})
ENDMACRO()
