...
MACRO(BUILD_TEST FILE_NAME)
  ...
  set(LTDL_LIBRARY_PATH "${PLUGIN_PATH}${SEP}${CMAKE_INSTALL_PREFIX}/lib/roboptim-core${SEP}$ENV{LTDL_LIBRARY_PATH}")
  IF(MSVC AND "${CMAKE_GENERATOR}" MATCHES "Visual Studio.*")
    set(LTDL_LIBRARY_PATH "${PLUGIN_PATH}/Release${SEP}${PLUGIN_PATH}/Debug${SEP}${LTDL_LIBRARY_PATH}")
  ENDIF()
  SET_PROPERTY(
  ...
  SET_PROPERTY(
    TEST ${EXE_NAME}${PROGRAM_SUFFIX} APPEND PROPERTY ENVIRONMENT
    "LD_LIBRARY_PATH=${PLUGIN_PATH}${SEP}$ENV{LD_LIBRARY_PATH}")
ENDMACRO()
