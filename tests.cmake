...
")
  ...
  SET_PROPERTY(
    ...
    "PATH=${Boost_LIBRARY_DIR};${CMAKE_INSTALL_PREFIX}/bin;${CMAKE_INSTALL_PREFIX}/lib;${PATH}"
    )
  SET_PROPERTY(
    TEST ${EXE_NAME}${PROGRAM_SUFFIX} PROPERTY ENVIRONMENT
    "LTDL_LIBRARY_PATH=${CMAKE_BINARY_DIR}/src/Release;${CMAKE_BINARY_DIR}/src/Debug;${CMAKE_INSTALL_PREFIX}/lib/roboptim-core/${LTDL_LIBRARY_PATH}")
  SET_PROPERTY(
    TEST ${EXE_NAME}${PROGRAM_SUFFIX} PROPERTY ENVIRONMENT
    "LD_LIBRARY_PATH=${CMAKE_BINARY_DIR}/src/Release")
ENDMACRO()
